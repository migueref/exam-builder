...
@section('content')
  ...
  <form class="container" action="/doctoral" method="post">
    {{ csrf_field() }}
    <section id="generales">
      <article>
        <h1>Examen de admisión al doctorado</h1>
        <p>Debido al alto número de solicitudes de admisión, CIFE realiza una prueba en línea para conocer su perfil vocacional y dominio de la competencia comunicativa respecto a la redacción de textos. Esta prueba se divide en dos partes: diagnóstico vocacional y redacción y comprensión de textos académicos. En el proceso de admisión solo se tendrá en cuenta esto último, en complemento con la evaluación global del currículo vitae.</p>
      </article>
        ...
        @foreach($exam->questions as $question)
          @if ($question->type==1)
            <div class="card-content wrap-text  ">
              ...
              @if ($question->id == 12 )
                <p><span class="card-title">Resumen de un texto. Lea por favor el siguiente art&iacute;culo corto: <a href="https://www.researchgate.net/publication/288671205_Sociedad_del_Conocimiento_Estudio_documental_desde_una_perspectiva_humanista_y_compleja" target="_blank" rel="noopener">Sociedad del conocimiento: Hacia una perspectiva humanista y compleja</a> y responda las siguientes preguntas:<br />12. La idea principal de la Introducci&oacute;n es:</span></p>
              @else
